...
oTitle <- fluidRow(
    column(width = 12,
           tags$div(
               HTML(paste(tags$span(style="font-weight:bold; color:#12454f", "FiNap"))), style = "font-size:1.7em"),
           tags$div(
               HTML(paste(tags$span(style="color:#1c5a66", "- Nap More, Worry Less -"))), style = "font-size:1.4em")
    ))
